...
|<span id="2">2</span>|must|"cnt-css-support": fails,|Acid2 test|picture not displayed as reference rendering|test is not specific enough|[test remove requested](https://github.com/w3c/epub-tests/issues/164)|
